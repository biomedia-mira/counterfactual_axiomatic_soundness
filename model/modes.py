...
from jax.experimental.stax import Conv, Relu, Sigmoid, elementwise, Flatten, Dense
from components.stax_layers import reshape
...
def get_layers_rgb_mode(input_shape: Tuple[int, ...]):
    ...
    discriminative = (Conv(32, filter_shape=(3, 3), padding='SAME'), Relu,
                      Conv(16, filter_shape=(3, 3), padding='SAME'), Relu,
    ...
    generative = (Conv(32, filter_shape=(3, 3), padding='SAME'), Relu,
                  Conv(8, filter_shape=(3, 3), padding='SAME'), Relu,
                  reshape((28 * 28 * 8, )),
                  Dense(28 * 28 * 8),
                  Relu, reshape((28, 28, 8)),
                  Conv(64, filter_shape=(3, 3), padding='SAME'), Relu,
                  Conv(32, filter_shape=(3, 3), padding='SAME'), Relu,
                  Conv(input_dim, filter_shape=(3, 3), padding='SAME'), Sigmoid)
    # generative = (Conv(64, filter_shape=(3, 3), padding='SAME'), Relu,
    #               reshape((28 * 28, 64)),
    #               linear_attention_layer(64, 28 * 28, heads=16), Relu,
    #               linear_attention_layer(64, 28 * 28, heads=16), Relu,
    #               Relu, reshape((28, 28, 64)),
    #               Conv(input_dim, filter_shape=(3, 3), padding='SAME'), Sigmoid)

    return discriminative, generative
