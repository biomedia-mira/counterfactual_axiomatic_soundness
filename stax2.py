...
from typing import Any, Iterable, Mapping, Sequence, Tuple, TypeVar, Union
from typing import NamedTuple

import jax.numpy as jnp
from jax import lax
from jax import random
from jax.nn import (elu, gelu, leaky_relu, log_softmax, relu, selu, sigmoid, softmax, softplus, standardize)
...
class Initializer(Protocol):
    def __call__(self, rng: KeyArray, shape: Shape) -> Params:
        pass
...
class ApplyFn(Protocol):
    def __call__(self, params: Params, rng: KeyArray, inputs: ArrayTree) -> ArrayTree:
        pass
...
def Dense(out_dim: int, w_init: Initializer = glorot_normal(), b_init: Initializer = normal()) -> StaxLayer:
    ...
    def apply_fn(params: Params, rng: KeyArray, inputs: ArrayTree) -> ArrayTree:
        w, b = params
